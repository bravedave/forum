...
<div class="form-group">
    ...
    <input type="text" name="tag" id="<?= $_uid = strings::rand()  ?>" class="form-control"
      value="<?= $this->data->dto->tag ?>" readonly />
...
<div class="row"><div class="col" id="link-display"></div></div>
